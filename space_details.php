...
<body style="margin-top:50px;">
  ...
  <div class="carousel-inner">
    ...
    <div class="item">
       <img src="image/Delux Room Single Bed Ac Room/img6.jpg"class="thumbnail" alt="img7">
    </div>
  </div>
...
?>
  ...
  <div class="row row-cols-2 row-cols-lg-5 g-2 g-lg-3">
    ...
    <!--Fatch Mysql Database Select Query Room Details -->
						<?php
            include('connection.php');
            $sql1=mysqli_query($con,"select * from space");
           while($result1= mysqli_fetch_assoc($sql1))
           {

            ?>
            <a href="space_details.php?room_id=<?php echo $result1['space_id']; ?>"><?php echo $result1['type']; ?></a><hr>
            <?php } ?>
    <!--Fatch Mysql Database Select Query Room Details -->
