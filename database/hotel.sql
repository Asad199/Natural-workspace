...
INSERT INTO `space` (`space_id`, `space_no`, `type`, `price`, `details`, `image`) VALUES
...
--
-- Table structure for table `space_booking_details`
--

CREATE TABLE `space_booking_details` (
  `id` int(11) NOT NULL,
  `name` char(50) NOT NULL,
  `email` varchar(50) NOT NULL,
...
--
-- Dumping data for table `space_booking_details`
--

INSERT INTO `space_booking_details` (`id`, `name`, `email`, `phone`, `address`, `city`, `state`, `zip`, `contry`, `space_type`, `check_in_date`, `check_in_time`, `check_out_date`, `Occupancy`) VALUES
...
--
-- Indexes for table `space_booking_details`
--
ALTER TABLE `space_booking_details`
  ADD PRIMARY KEY (`id`);
...
--
ALTER TABLE `space`
  MODIFY `space_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
--
-- AUTO_INCREMENT for table `space_booking_details`
--
ALTER TABLE `space_booking_details`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
--
