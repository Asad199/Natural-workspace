...
<div class="container text-center">    
  <h1>Welcome To <font color="#1fdb1f;"><b>Natural Space</b></font></h1><hr><br>
  <div class="row">
    <div class="hov"><!--Hov is Class-->
    
	
	<?php 
	$sql=mysqli_query($con,"select * from space");
	...
	<div class="col-sm-4">
      ...
      <p class="text-justify"><?php echo substr($r_res['details'],0,100); ?></p><br>
	    <a href="space_details.php?room_id=<?php echo $r_res['space_id']; ?>" class="btn btn-danger text-center">Book Now</a><br><br>
    </div>
	<?php } ?>
  </div>
  </div>
