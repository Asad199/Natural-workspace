...
<nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="dashboard.php?option=admin_profile">Welcome <?php echo $admin; ?></a>
        </div>
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            ...
            <li><a href="dashboard.php?option=rooms">Space</a></li>
...
else
{
	...
	else if($opt=="add_space")
	{
	include('add_space.php');	
	}
