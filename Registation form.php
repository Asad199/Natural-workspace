...
if(isset($save))
{
  $sql= mysqli_query($con,"select * from create_account where Name='$name' ");
  ...
  else
  {
      ...
      $sql="insert into create_account(name, email, password,mobile,address,gender,country,pictrure) values('$name','$email','$Passw','$mobi','$addr','$gend','$countr','$pict')";
